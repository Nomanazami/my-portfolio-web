...
//   // Filter others by type
//   const filteredOthers =
//     filter === "All" ? others : others.filter((p) => p.type === filter);
//   const visibleOthers = showAll ? filteredOthers : filteredOthers.slice(0, 3);
...
//         <h3 className="text-xl font-semibold text-purple-300">🛠️ Other Projects</h3>
...
//             {showAll
//               ? "Show Less ▲"
//               : `Show More (${filteredOthers.length - 3} more) ▼`}
//           </button>
//         )}
//         <a
